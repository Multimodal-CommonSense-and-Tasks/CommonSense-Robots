...
from ET.model_util import generate_attention_mask
from ET.encodings import PosEncoding, PosLearnedEncoding, TokenLearnedEncoding
...
class EncoderVL(nn.Module):
    def __init__(self, args):
        ...
        self.enc_pos_learn = (
            PosLearnedEncoding(args.demb) if args.enc["pos_learn"] else None
        )
    ...
    def forward(
        ...
        for i, (len_l, len_f, len_a) in enumerate(
            ...
            # mask padded frames
            mask_pad[
                i, length_lang_max + len_f : length_lang_max + length_frames_max
            ] = True
            # mask padded actions
        ...
        if attn_masks:
            ...
            mask_attn = generate_attention_mask(
                length_lang_max,
                length_frames_max,
                emb_all.device,
    ...
    def encode_inputs(
        self, emb_lang, emb_frames, emb_actions, lengths_lang, lengths_frames, mask_pad
    ):
        """
