...
class Module(Base):
    ...
    def featurize(self, batch, load_mask=True, load_frames=True):
        ...
        print("feat",type(feat),feat.keys())
        for ex in batch:
            ###########
            # auxillary
            ###########
            ...
            # print("numnumnum",type(feat['num']['lang_instr'] ))
    ...
    def serialize_lang_action(self, feat):
        ...
        '''
        # print("aaaaaaaabbbbbbb")
        is_serialized = not isinstance(feat['num']['lang_instr'][0], list)
        if not is_serialized:
            feat['num']['lang_instr'] = [word for desc in feat['num']['lang_instr'] for word in desc]
            if not self.test_mode:
                
                # print('action_low',feat['num']['action_low'])
