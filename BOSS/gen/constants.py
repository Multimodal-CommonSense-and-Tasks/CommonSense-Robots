...
PICKUP_REPEAT_MAX = (
    4  # how many of the target pickup object to generate in [1, MAX] (randomly chosen)
)
RECEPTACLE_SPARSE_POINTS = (
    50  # increment for how many points to leave free for sparsely populated receptacles
)
RECEPTACLE_EMPTY_POINTS = (
    200  # increment for how many points to leave free for empty receptacles
)

MIN_VISIBLE_RATIO = (
    0.0011  # minimum area ratio (with respect to image size) of visible object
)
PLANNER_MAX_STEPS = (
    100  # if the generated plan is more than these steps, discard the traj
)
...
GOALS_VALID = {
    "pick_and_place_simple": {"Kitchen", "LivingRoom", "Bathroom", "Bedroom"},
...
NON_RECEPTACLES_SET = (OBJECTS_SET - set(VAL_RECEPTACLE_OBJECTS.keys())) | set(
    MOVABLE_RECEPTACLES
)
...
OBJ_CLS_VOCAB = "data/obj_cls.vocab"
########################################################################################################################
